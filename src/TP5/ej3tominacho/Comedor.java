...
public class Comedor {
    ...
    public void comerPerro() throws InterruptedException{
        ...
        cantPerros--;
        cuentaActual++;
        if ((cuentaActual == limitePorEspecie && cantPerros != 0) || cantPerros == 0) {
            cambio = true;
        }
       
        System.out.println(Thread.currentThread().getName() + " ESTA COMIENDOO. + CANT: "+cuentaActual);
        Thread.sleep(200);
    ...
    public void comerGato() throws InterruptedException{
        ...
        cantGatos--;
        cuentaActual++;
        if ((cuentaActual == limitePorEspecie && cantGatos != 0) || cantGatos == 0) {
            cambio = true;
        }
        System.out.println(Thread.currentThread().getName() + " ESTA COMIENDOO. + CANT: "+cuentaActual);
        Thread.sleep(200);
